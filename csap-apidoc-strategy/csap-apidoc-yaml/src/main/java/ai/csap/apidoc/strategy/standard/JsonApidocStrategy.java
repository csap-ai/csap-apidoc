...
public class JsonApidocStrategy extends AbstractApidocStrategy {

    public JsonApidocStrategy(ControllerHandle controllerHandle, EnumHandle enumHandle,
    ...
    public String getName() {
        return ApiStrategyType.JSON.getName();
    }

    @Override
    public String getSuffix() {
        return ApiStrategyType.JSON.getSuffix();
    }
